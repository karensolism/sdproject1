                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="ciudades"
                                            class="{{ Request::path() === 'ciudades/index' ? 'nav-link active' : 'nav-link' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Ciudad</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="colonias"
                                            class="{{ Request::path() === 'colonias/index' ? 'nav-link active' : 'nav-link' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Colonia</p>
                                        </a>
                                    </li>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/Direccion/Estado"
                                            class="{{ Request::path() === '/Direccion/Estado' ? 'nav-link active' : 'nav-link' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Estado</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/Direccion/Ciudad"
                                            class="{{ Request::path() === '/Direccion/Ciudad' ? 'nav-link active' : 'nav-link' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Ciudad</p>
                                        </a>
                                    </li>
